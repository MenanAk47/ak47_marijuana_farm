...
RegisterNetEvent('ak47_marijuana_farm:openbossaction')
AddEventHandler('ak47_marijuana_farm:openbossaction', function()
    TriggerEvent('esx_society:openBossMenu', 'marijuana', function(data, menu)
        menu.close()
        inBossMenu = false
    end)
...
AddEventHandler('ak47_marijuana_farm:notify', function(msg)
